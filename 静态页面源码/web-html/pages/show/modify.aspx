<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modify.aspx.cs" Inherits="City_Web.静态页面源码.web_html.pages.show.modify" %>
							...
							<table border="0" width="650" height="300" rules="all" cellspacing="0">
								...
								<tr align="center" height="50">
									<td>
										...
										&nbsp;<asp:Button ID="Button_OK" runat="server" Text="修改" OnClick="Button_OK_Click" />&nbsp
